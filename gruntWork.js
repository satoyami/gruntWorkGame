...
var weights = [
  {'name':'pink-kb','qty':13,'lbs':15,'pts':1,'load':2},
  {'name':'blue-kb','qty':12,'lbs':25,'pts':2,'load':2},
  {'name':'yellow-kb','qty':6,'lbs':35,'pts':3,'load':2},
  {'name':'plate10','qty':17,'lbs':10,'pts':1,'load':5},
  {'name':'plate15','qty':19,'lbs':15,'pts':2,'load':3},
  {'name':'plate25','qty':16,'lbs':25,'pts':3,'load':3},
  {'name':'plate35','qty':8,'lbs':35,'pts':4,'load':2},
  {'name':'plate45','qty':6,'lbs':45,'pts':5,'load':2},
  {'name':'bag1','qty':1,'lbs':90,'pts':8,'load':1}
];
